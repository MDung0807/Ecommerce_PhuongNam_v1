namespace Ecommerce_PhuongNam_v1.Application.Interfaces
{
    ...
    public interface IService<in TCreate, in TUpdate, in TId, TResponse, in TPaging, TPagingResult>
    {
        ...
        /// <returns></returns>
        Task<bool> Update(TUpdate entity);
        ...
        /// <returns></returns>
        Task<bool> Create(TCreate entity);
        ...
        /// <returns></returns>
        Task<bool> ChangeIsActive(TId id);
        ...
        /// <param name="id">primary key entity</param>
        /// <returns></returns>
        Task<bool> ChangeToWaiting(TId id);
        ...
        /// <param name="id">primary key entity</param>
        /// <returns></returns>
        Task<bool> ChangeToDisable(TId id);
